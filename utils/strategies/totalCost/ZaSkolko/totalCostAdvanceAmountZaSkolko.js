export const totalCostAdvanceAmountZaSkolko = {
  key: 'totalCostAdvanceAmountZaSkolko',
  label: 'Итого цена договора с учетом потери стоимости при авансировании, сумма',
  dependsOn: ['saleFields', 'creditAmount', 'creditPercent', 'creditDays', 'inflation', 'delayDays', 'advanceAmount'],
  calculate: ({ saleFields, creditAmount, creditPercent, creditDays, inflation, delayDays, advanceAmount}) => {
