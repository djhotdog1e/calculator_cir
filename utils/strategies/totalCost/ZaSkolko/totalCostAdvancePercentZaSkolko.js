export const totalCostAdvancePercentZaSkolko = {
  key: 'totalCostAdvancePercentZaSkolko',
  label: 'Итого цена договора с учетом потери стоимости при авансировании, %',
  dependsOn: ['saleFields', 'creditAmount', 'creditPercent', 'creditDays', 'inflation', 'delayDays', 'advancePercent'],
  calculate: ({ saleFields, creditAmount, creditPercent, creditDays, inflation, delayDays, advancePercent}) => {
